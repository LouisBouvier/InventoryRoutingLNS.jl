...
"""
function TSP_neighborhood!(;route::Route, instance::Instance, neighborhood_index::Int, index_1::Int, index_2::Int, stats::Dict, in_LNS::Bool)
...
or the neighborhood of the LNS if `true`).
"""
function iterative_TSP_neighborhood!(;route::Route, instance::Instance, neighborhood_index::Int, stats::Dict, in_LNS::Bool)
    improvement = true
    while improvement
        improvement = false
